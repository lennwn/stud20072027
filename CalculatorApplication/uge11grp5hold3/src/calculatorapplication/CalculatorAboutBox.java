...
public class CalculatorAboutBox extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(calculatorapplication.CalculatorApplication.class).getContext().getResourceMap(CalculatorAboutBox.class);
        setTitle(resourceMap.getString("title")); // NOI18N
        setModal(true);
        setName("aboutBox"); // NOI18N
        setResizable(false);

        javax.swing.ActionMap actionMap = org.jdesktop.application.Application.getInstance(calculatorapplication.CalculatorApplication.class).getContext().getActionMap(CalculatorAboutBox.class, this);
